        ...
        <section className="px-4 bg-[#F1F1F1] h-screen py-4 w-full">
            <div className="">
                ...
                <div className="">
                    ...
                    <div>
                        <h1 className="text-[18px] text-center text-[#080705] font-Figtree">Connect with wallet</h1>
                        <h1 className="text-[14px] items-center text-center font-Figtree text-[#5A5A58]">Your crypto wallet securely stores your <br /> digital and crypto currencies. </h1>
                    </div>
                </div>
                </div>
