        ...
        <div className="py-4  gap-9">
          ...
          <div className="grid py-7 gap-[13px]">
            ...
            <div className="bg-[#FFFFFF] w-[51vh] grid rounded-[8px] h-[16vh] justify-center items-center">
                <h1 className="text-[16px] text-[#146B48] font-Figtree">Offer accepted</h1>
                <p className="text-[13px] text-[#5A5A58] font-Figtree">Your offer for Kanpai Panda made to Gwills have <br /> been accepted, Go ahead and send....</p>
                 </div>
            </Link>
            <div className="bg-[#FFFFFF] w-[51vh] grid rounded-[8px] h-[16vh] justify-center items-center">
                <h1 className="text-[16px] text-[#AB0000] font-Figtree">Offer declined</h1>
                <h2 className="text-[13px] text-[#5A5A58] font-Figtree">Your offer for Kanpai Panda made to Gwills have <br /> been accepted, Go ahead and send....</h2>
                 </div>
            <div className="bg-[#FFFFFF] w-[51vh] grid rounded-[8px] h-[16vh] justify-center items-center">
                <h1 className="text-[16px] text-[#146B48] font-Figtree">Offer accepted</h1>
                <p className="text-[13px] text-[#5A5A58] font-Figtree">Your offer for Kanpai Panda made to Gwills have <br /> been accepted, Go ahead and send....</p>
