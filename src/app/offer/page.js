  ...
  return (
    <section className="bg-[#F1F1F1] h-full w-full px-4">
      <div className="py-4  gap-9">
        ...
        <div className="">
          ...
          <div className="flex justify-center">
            <div className="grid text-center">
              <h1 className="text-[#146B48] text-[18px] font-Figtree">
                Successful
              </h1>
              <h1 className="text-[#5A5A58] text-[16px] font-Figtree">
        ...
        <Link
          href={{ pathname: "/Transaction" }}
          className="flex justify-center py-5"
        >
          <button className="w-[65vh] h-[9vh] text-[#FFFFFF] font-Figtree text-[16px] rounded-[8px] bg-[#146B48]">
            Make an offer
          </button>
        </Link>
      </div>
